    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <Text style={styles.creditSubTitle}>Find your access code via SMS in your phone or via email</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Access Code"
                    placeholderTextColor="grey"
                />
                <Pressable style={styles.submitButton} onPress={() => navigation.navigate('MainTabs')}>
