...
<View style={styles.centerTextContainer}>
  <Text style={styles.centerText}>
    <Text style={{ color: 'green' }}>_</Text> {/* First step in green */}
    ...
    <Ionicons name="close" size={24} color="black" />
      ...
      <ImageBackground source={require('./image.jpg')} style={styles.bottomImage}>
        <View style={styles.overlayBottom}>
          ...
          <TextInput  
          onChange={(text)=>{setHealthCardNumber(text)}}
          style={styles.textInput} placeholder="Enter your information" placeholderTextColor="white" />
        <TouchableOpacity style={styles.button} onPress={() =>{  
          if(healthCardNumber===realNumber){
          navigation.navigate('WantToRegister')}
          else{navigation.navigate('WeFoundYou')}
          }}>
