...
import { View, Text, ImageBackground, StyleSheet, Dimensions, ActivityIndicator, Animated } from 'react-native';
        ...
        <View style={styles.overlay}>
          {loading ? (
            ...
            <Animated.View style={{ opacity: fadeAnim, width: '100%', alignItems: 'center' }}>
              <Svg width={50} height={30} style={{ marginBottom: 20, padding: 0 }} source={require('../../../assets/greenprofile.svg')} />
              <Text style={styles.title}>We Found You</Text>
              <Text style={styles.description}>
                We have found your health card number in our system as a current patient, now you'll be redirected to the log in screen.
              </Text>
            </Animated.View>
          ) : null}
        </View>
